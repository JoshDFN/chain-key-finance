...
actor {
    ...
    private stable var name_ : Text = "Chain-Key USD Coin";
    private stable var symbol_ : Text = "ckUSDC";
    private stable var decimals_ : Nat8 = 6;
    private stable var fee_ : Nat = 10000; // 0.01 USDC
