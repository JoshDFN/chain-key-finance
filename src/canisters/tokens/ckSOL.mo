...
actor {
    ...
    private stable var name_ : Text = "Chain-Key Solana";
    private stable var symbol_ : Text = "ckSOL";
    private stable var decimals_ : Nat8 = 9;
    private stable var fee_ : Nat = 5000000; // 0.005 SOL
